...
public final class APIUserAuthenticator {

    private static APIUserAuthenticator authenticator = null;
    ...
    private APIUserAuthenticator() {
         ...
         */
        serviceKeysStorage.put( "f80ebc87-ad5c-4b29-9366-5359768df5a1", "karan" );
        serviceKeysStorage.put( "3b91cab8-926f-49b6-ba00-920bcf934c2a", "username2" );
    }

    public static APIUserAuthenticator getInstance() {
        if ( authenticator == null ) {
            authenticator = new APIUserAuthenticator();
        }
